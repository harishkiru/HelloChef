...
![Login Screen](assets/loginingin.gif) <!-- Replace with actual login screen GIF -->
...
![Navigation Demo](assets/navigatingdifferentwindows.gif) <!-- Replace with navigation GIF -->
...
![Video Tutorial](assets/watchingvideos.gif) <!-- Replace with video tutorial GIF -->
...
![Progress Tracking](assets/trackingprogress.jpg) <!-- Replace with progress tracking demo -->
...
![Badges Screen](assets/earnbadges.jpg) <!-- Replace with badges demo -->

### 🏆 Compete on the Leaderboard
See how you stack up against other users as you level up your cooking skills.

![Leaderboard](assets/scoreboard.jpg) <!-- Replace with leaderboard demo -->
...
![Recipe Page](assets/readingrecipes.gif) <!-- Replace with recipe screen -->
...
![Profile Customization](assets/choosinganewpfp.gif) <!-- Replace with pfp customization demo -->
...
![Dark Mode](assets/darkmode.gif) <!-- Replace with dark mode toggle demo -->
